...
exports.botToken = exports.port = exports.parentTempVoiceId = exports.tempVoiceName = exports.userChannelPermissions = exports.botActivityType = exports.botActivity = exports.botPrefix = void 0;
...
exports.parentTempVoiceId = JSON.parse(process.env.PARENT_CH ?? "[]");
exports.port = process.env.PORT ? process.env.PORT : 3000;
exports.botToken = process.env.DISCORD_TOKEN ?? "";
